...
import models.TraingSurveys;
//TODO

public class TraingSurveysAcces extends RestRequest {
	public static TraingSurveys get(Integer traingSurveys) throws IOException, URISyntaxException {
		String JSONts = getAllOrOne(new URI(Constants.ADDRESS_SOURCE + surve));
