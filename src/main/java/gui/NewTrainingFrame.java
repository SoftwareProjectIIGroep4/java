...
public class NewTrainingFrame extends JFrame {
	...
	public NewTrainingFrame() {
		...
		lblTraining.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				dispose();
				TrainingFrame newFrame = new TrainingFrame();
		...
		lblEmployees.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				dispose();
				EmployeeFrame newFrame = new EmployeeFrame();
				newFrame.setVisible(true);
			}	
		});
		...
		lblStatistics.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				dispose();
				StatistiekenFrame newFrame = new StatistiekenFrame();
				newFrame.setVisible(true);
			}
		});
